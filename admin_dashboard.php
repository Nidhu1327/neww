     ...
     <div id="content-wrapper">
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Admin / Booking Tickets</li>
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  <thead>
                    <tr>
                      ...
                      <th style="background: #dc3545;color: #fff;">ID Number</th>
                      ...
                      <th style="background: #dc3545;color: #fff;">Mobile</th>
                      <th style="background: #dc3545;color: #fff;">Booked By</th>
...
<?php
	if(isset($_POST['submit']))
	{
		...
		//move_uploaded_file($_FILES['pimg']['tmp_name'],"upload/$pimg");
		 ...
		 mysql_query("insert into ticket_booking(pass_name,pass_id_proof,age,book_by,from_address,to_address,no_tickets,ticket_amount,mobile,status)values('$pass_name','$pass_id_proof','$age','$book_by','$from_address','$to_address','$no_ticket','','$mobile','Waiting')");
		//echo "insert into ticket_booking(pass_name,pass_id_proof,from_address,to_address,no_ticket,mobile,status)values('$pass_name','$pass_id_proof','$from_address','$to_address','$no_ticket','$mobile','Waiting')";	exit;
