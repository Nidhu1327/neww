        ...
        <div class="container-fluid">
          ...
          <div class="card mb-3">
            ...
            <div class="card-body">
			 ...
			 <?php
				$uid=$_SESSION['uid'];
				$q=mysql_query("select * from ticket_booking where user_id ='$uid' and status='Waiting' order by book_id desc");
				$c=mysql_num_rows($q);
			?>
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  <thead>
                    <tr>
                      ...
                      <th style="background: #dc3545;color: #fff;">Action</th>
                    </tr>
                  </thead>
							...
							echo "<tr>
									...
									<td>
										<form action='#' method='post' name='updatestatus'>
											...
											<input class='btn btn-danger' type='submit' name='submit' value='Cancel Ticket'> 
										</form> 
									</td>									
								</tr>";
						}
...
if(isset($_POST['submit'])){
	...
	mysql_query("update ticket_booking SET status='Cancelled' where book_id = '$book_id'");
