        ...
        <div class="container-fluid">
          ...
          <div class="card mb-3">
            ...
            <div class="card-body">
			 ...
			 <?php
				$uid=$_SESSION['uid'];
				$q=mysql_query("select * from ticket_booking where user_id ='$uid' and status='Waiting for Payment' order by book_id desc");
				$c=mysql_num_rows($q);
			?>
				  ...
				  <?php
						...
						{		
							...
							echo "<tr>
									...
									<td>$book_by</td>
									<td>$status</td>
									<td><a href='payment.php?pid=$book_id&pass_name=$pass_name&no_tickets=$no_tickets&amount=$amount'>Booking</a></td>									
								</tr>";
						}
