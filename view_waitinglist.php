      ...
      <div id="content-wrapper">
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Admin / Waiting List</li>
							...
							echo "<tr>
									...
									<td>
										<form action='#' method='post' name='updatestatus'>
											...
											<input class='btn btn-success' type='submit' name='reject' value='Reject'>
										</form> 
									</td>								
								</tr>";
						}
...
if(isset($_POST['submit'])){
	...
	mysql_query("update hotel_booking SET status='Approved' where book_id = '$book_id'");
	echo "<script type='text/javascript'>alert('Send for Payment');</script>";
	echo '<meta http-equiv="refresh" content="0;url=admin_hotel_book.php">';                                      
}

if(isset($_POST['reject'])){
	$book_id = $_POST['book_id'];		
	mysql_query("update hotel_booking SET status='Room Not Avail' where book_id = '$book_id'");
	echo "<script type='text/javascript'>alert('Ticket is not Available');</script>";
	echo '<meta http-equiv="refresh" content="0;url=admin_hotel_book.php">';                                      
}
